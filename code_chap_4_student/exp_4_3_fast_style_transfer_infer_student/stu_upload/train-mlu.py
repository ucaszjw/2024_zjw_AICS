...
if __name__ == '__main__':
    ...
    s1, s2, s3, s4 = mlu_net.forward(mlu_image_style)
    ...
    while j <= epochs:
        for i, image in enumerate(data_loader):
            ...
            mlu_image_g = mlu_g_net.forward(mlu_image_c)
            #TODO: 利用特征提取网络mlu_net提取生成图像mlu_image_g的特征out1-out4
            out1, out2, out3, out4 = mlu_net.forward(mlu_image_g)
            ##############计算风格损失#################
            ...
            c1, c2, c3, c4 = mlu_net.forward(mlu_image_c)
            ...
            if i % 10 == 0:
                ...
                save_image(torch.cat((mlu_image_g, mlu_image_c), dim=3), './out/train_mlu/%d-%d.jpg' % (j, i))
        j += 1
